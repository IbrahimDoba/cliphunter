...
function GenerateContent() {
  ...
  const [framingMode, setFramingMode] = useState<'crop' | 'fit'>('fit');
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <Select
                value={framingMode}
                onValueChange={(value: 'crop' | 'fit') => setFramingMode(value)}
                disabled={isLoading}
              >
                <SelectTrigger id="framing-mode" className="w-full">
                  <SelectValue placeholder="Select framing mode" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="fit">Fit (Better Quality - Letterbox)</SelectItem>
                  <SelectItem value="crop">Crop (Center Crop - Full Frame)</SelectItem>
                </SelectContent>
              </Select>
              <p className="text-xs text-muted-foreground mt-1">
                Fit: Keeps entire video visible with black bars. Best quality, no content loss.<br />
                Crop: Zooms to fill frame. May cut off edges.
              </p>
            </div>
