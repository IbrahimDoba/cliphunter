...
// Re-export Prisma enums for use in the app
export type CompilationStatus = PrismaCompilationStatus;
export type NarrationStyle = PrismaNarrationStyle;
export type SubtitleStyle = PrismaSubtitleStyle;
export type ClipAudioMode = PrismaClipAudioMode;
